...
/**
 * Generates a slug for a heading (maintains accents and emojis for working links).
...
export function generateSlug(text: string): string {
  return text
    .toLowerCase()
    // Keep emojis as they are for link compatibility
    // Remove only problematic special characters but keep accented letters and emojis
